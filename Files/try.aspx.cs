    ...
    public partial class _try : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string querys = "SELECT rno, snm FROM student where class=@class and sem=@sem and div=@div";
                    ...
                    if (row.Cells.Count >= 3)
                    {
                        ...
                        if (control is CheckBox)
                        {
                            ...
                            if (checkBox.Checked)
                            {
                                ...
                                string query = "INSERT INTO Attendance (dt, class, sem, div, subject, session, rno, snm) VALUES (@dt, @class, @sem, @div, @subject, @session, @rno, @snm)";
                                ...
                                using (SqlCommand command = new SqlCommand(query, connection))
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (rowsAffected == 1)
                                        {
                                            L1.Text += "Attendance inserted successfully for " + rno + " - " + snm + "<br />";
                                        }
                                    }
                                    catch (Exception ex)
                                    {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage_Subject.aspx.cs" Inherits="Project_Attendance_System.Files.Manage_Subject" %>
        ...
        <div class="container">
            ...
            <div class="table-container">
                <div class="inline-form" style="float:right;">
                    <asp:Button ID="AddSubject" runat="server" Text="Add New Subject" Style="width: 110%;" CssClass="btn-submit" OnClick="AddSubject_Click" />
                </div>
                <asp:GridView ID="gvTeachers" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="sub_teacher" HeaderText="Subject Teacher" />
                        <asp:BoundField DataField="sub_class" HeaderText="Subject Class" />
                        <asp:BoundField DataField="sub_sem" HeaderText="Subject Semester" />
                        <asp:BoundField DataField="sub_div" HeaderText="Subject Division" />
